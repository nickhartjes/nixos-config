{
  ...
  options.components.development.infrastructure.k9s = {
    enable = lib.mkEnableOption "k9s Kubernetes CLI management tool";
  };

  config = lib.mkIf config.components.development.infrastructure.k9s.enable {
    programs.k9s = {
      enable = true;
